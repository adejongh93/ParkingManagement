...
{
    internal class VehicleStayMapper : IMapper, IVehicleStayMapper
    {
        private readonly IMapper mapper;

        public VehicleStayMapper()
        {
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<VehicleStay, VehicleStayDto>();
                cfg.CreateMap<VehicleStayDto, VehicleStay>();
            });

            mapper = config.CreateMapper();
        }

        public VehicleStayDto Map(VehicleStay vehicleStay)
        {
            return Map<VehicleStayDto>(vehicleStay);
        }

        public VehicleStay Map(VehicleStayDto vehicleStayDto)
        {
            return Map<VehicleStay>(vehicleStayDto);
        }
